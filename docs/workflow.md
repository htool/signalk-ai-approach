...
## 1. Ensure the AI approach is current

Before a plugin task, retrieve [this approach](https://github.com/htool/signalk-ai-approach) from **`main`**. Clone or `git pull`, or read it on GitHub — either is fine. Do not use a previous chat’s copy. Do not copy these pages into the plugin tree.

## 2. Sync the fork first
...
## 3. Decide what belongs upstream
